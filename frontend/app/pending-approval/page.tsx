  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-10 text-white">
      <Card className="max-w-lg rounded-lg text-center">
        ...
        <h1 className="mt-6 text-3xl font-semibold text-white">Waiting for admin approval</h1>
        <p className="mt-3 text-slate-400">
          Your UniRide account was submitted successfully. An admin must approve your university ID before you can access the dashboard.
        </p>
