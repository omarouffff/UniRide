...
function ResetPasswordForm() {
  ...
  async function onSubmit(values: Values) {
    if (!token) {
      toast({ variant: 'error', title: 'Invalid link', description: 'Reset token is missing from the URL.' });
      return;
    }
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 text-white">
        <section className="w-full max-w-md rounded-lg border border-white/10 bg-white/5 p-7 text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Request a new password reset email.</p>
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 text-white">
        <section className="w-full max-w-md rounded-lg border border-emerald-500/30 bg-emerald-500/10 p-7 text-center">
          <h1 className="text-xl font-semibold text-emerald-200">Password updated</h1>
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-10 text-white">
      <section className="w-full max-w-md rounded-lg border border-white/10 bg-white/5 p-7 shadow-2xl">
        ...
        <p className="mt-2 text-sm text-slate-400">Choose a strong password for your UniRide account.</p>
